<template>
  <nav class="dark:bg-gray-dark bg-white border-gray-200 dark:bg-gray-900">
    ...
    >
      ...
      <div
        class="w-full z-20 xs:transition-transform xs:translate-x-full bg-white dark:bg-gray-dark md:translate-x-0 md:block md:w-auto xs:h-[28vh] xs:rounded-bl-full lg:relative md:relative sm:absolute xs:absolute xs:top-0 s:top-0 xs:right-0 s:right-0 lg:h-auto md:h-auto xs:w-[48vw] md:shadow-none"
